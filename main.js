...
var _user$project$Main$viewWeather = function (weatherWebData) {
	var _p0 = weatherWebData;
	switch (_p0.ctor) {
		case 'NotAsked':
			...
			return _rundis$elm_bootstrap$Bootstrap_Alert$danger(
				{
					ctor: '::',
					_0: A2(
						_rundis$elm_bootstrap$Bootstrap_Alert$h3,
						{ctor: '[]'},
						{
							ctor: '::',
			...
			return _rundis$elm_bootstrap$Bootstrap_Alert$info(
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Weather'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(_p0._0.summary),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
										...
										A2(
											...
											A2(
												...
												_elm_lang$core$Basics$toString(
													_elm_lang$core$Basics$round(_p0._0.temperature)),
												'°C'))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
...
var _user$project$Main$viewCoords = function (coordinatesWebData) {
	var _p1 = coordinatesWebData;
	switch (_p1.ctor) {
		case 'NotAsked':
			return _elm_lang$html$Html$text('');
		case 'Loading':
			...
			return _rundis$elm_bootstrap$Bootstrap_Alert$success(
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(_p1._0.latitude),
								A2(
									_elm_lang$core$Basics_ops['++'],
									', ',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(_p1._0.longitude),
										')'))))),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Main$emptyModel = {input: '', coordinates: _krisajenkins$remotedata$RemoteData$NotAsked, weather: _krisajenkins$remotedata$RemoteData$NotAsked};
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$Main$emptyModel,
	{ctor: '[]'});
var _user$project$Main$Coordinates = F2(
	function (a, b) {
		return {latitude: a, longitude: b};
	});
var _user$project$Main$coordinatesDecoder = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	A2(
		...
		A2(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Json_Decode$float))),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Coordinates)));
var _user$project$Main$Weather = F2(
	function (a, b) {
		return {summary: a, temperature: b};
	});
var _user$project$Main$weatherDecoder = A3(
	...
	A3(
		...
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Weather)));
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {input: a, coordinates: b, weather: c};
	});
var _user$project$Main$WeatherResponse = function (a) {
	return {ctor: 'WeatherResponse', _0: a};
};
var _user$project$Main$getWeather = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Main$WeatherResponse,
		_krisajenkins$remotedata$RemoteData$sendRequest(
			A2(
				_elm_lang$http$Http$get,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'https://api.darksky.net/forecast/ef6fa285d158d903b73b56d355195759/',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_p3.latitude),
						A2(
							_elm_lang$core$Basics_ops['++'],
							',',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(_p3.longitude),
								'?units=si')))),
				_user$project$Main$weatherDecoder)));
};
var _user$project$Main$CoordResponse = function (a) {
	return {ctor: 'CoordResponse', _0: a};
};
var _user$project$Main$getNews = function (address) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Main$CoordResponse,
		_krisajenkins$remotedata$RemoteData$sendRequest(
			A2(
				_elm_lang$http$Http$get,
				A2(_elm_lang$core$Basics_ops['++'], 'http://maps.googleapis.com/maps/api/geocode/json?address=', address),
				_user$project$Main$coordinatesDecoder)));
};
		...
		switch (_p4.ctor) {
			...
			case 'Submit':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{coordinates: _krisajenkins$remotedata$RemoteData$Loading}),
					{
						ctor: '::',
						_0: _user$project$Main$getNews(model.input),
						_1: {ctor: '[]'}
					});
			case 'CoordResponse':
				if (_p4._0.ctor === 'Success') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{coordinates: _p4._0, weather: _krisajenkins$remotedata$RemoteData$Loading}),
						{
							ctor: '::',
							_0: _user$project$Main$getWeather(_p4._0._0),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
							...
							},
							{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
											{
												ctor: '::',
												_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$placeholder('Address'),
												_1: {
													ctor: '::',
										...
										_1: {
											...
											_0: A2(
												_rundis$elm_bootstrap$Bootstrap_Button$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$Submit),
														_1: {
															ctor: '::',
															_0: _rundis$elm_bootstrap$Bootstrap_Button$disabled(
																_elm_lang$core$Native_Utils.eq(model.input, '')),
															_1: {ctor: '[]'}
														}
													}
												},
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Main$viewCoords(model.coordinates),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$Main$viewWeather(model.weather),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
